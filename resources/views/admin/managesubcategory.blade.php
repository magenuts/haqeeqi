                                         ...
                                         @else
                                          ...
                                          @foreach($category_list as $list)
                                            <tr>
                                                ...
                                                <td><a href="{{url('/admin/editsubcategory',$list->id)}}"><button type="button" class="btn waves-effect waves-light   btn-warning">Edit</button></a>
                                              <!-- <a href="{{url('/admin/deletecategory',$list->id)}}"  onclick="return confirm('Are You Sure to delete this category?')"> -->  <button type="button" class="btn waves-effect waves-light  btn-danger del-button" data-id="{{ $list->id }}">Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            @endif
