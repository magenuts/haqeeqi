...
<!--===============================================================================================-->  
    <link rel="icon" type="image/png" href="{{url('/admin_assets')}}/images/icons/favicon.ico"/>
<!--===============================================================================================-->
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="POST" id="loginform" action="{{url('/admin/login')}}">
                    <span class="login100-form-title p-b-34">
                        Account Login
                          ...
                          {!! csrf_field() !!}
                            ...
                            <div class="alert alert-warning"><button class="close" data-dismiss="alert"></button><strong>Error! </strong>{{Session::get('login_feedback')}}.</div>
                            @endif
                           
                   
                    <div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20" data-validate="Type email">
                        <input id="first-name" class="input100" name="email" type="email"  placeholder="Email" value="{{old('email')}}">
                ...
                <div class="login100-more" style="background-image: url('admin_assets/images/bg-01.jpg');"></div>
            </div>
        </div>
    </div>
...
<!--===============================================================================================-->
    <script src="{{url('/admin_assets')}}/vendor/jquery/jquery-3.2.1.min.js"></script>
<!--===============================================================================================-->
    <script src="{{url('/admin_assets')}}/vendor/animsition/js/animsition.min.js"></script>
<!--===============================================================================================-->
