...
@endsection
                              ...
                              <form class="m-t-40"  id="category-form" enctype="multipart/form-data" >
                                ...
                                {!! csrf_field() !!}
                                  <div class="form-group m-b-40">
                                      <label for="input1">Parent Category</label>
                                     <select name="maincategory" class="browser-default custom-select dynamic " id="maincategory">
    <option value="" disabled selected="true">Select main category</option>
  ...
  @endforeach
                                  ...
                                  <div class="form-group m-b-40">
                                   <label for="input1">Subcategory</label>
                                     <select name="maincategory" class="browser-default custom-select " id="subcategory">
